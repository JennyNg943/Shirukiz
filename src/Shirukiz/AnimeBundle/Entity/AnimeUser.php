...
namespace Shirukiz\AnimeBundle\Entity;
...
class AnimeUser
{
     ...
     * @ORM\Id
     *
     * @ORM\ManyToOne(targetEntity="Shirukiz\AnimeBundle\Entity\Anime",cascade={"persist"})
     */
    private $idAnime;
     ...
     * Set idAnime
     *
     * @param \Shirukiz\AnimeBundle\Entity\Anime $idAnime
     *
     * @return AnimeUser
     */
    public function setIdAnime(\Shirukiz\AnimeBundle\Entity\Anime $idAnime)
    {
     ...
     * Get idAnime
     *
     * @return \Shirukiz\AnimeBundle\Entity\Anime
     */
