...
namespace Shirukiz\JeuxVideoBundle\Entity;
 ...
 *
 * @ORM\Table(name="jeux")
 * @ORM\Entity(repositoryClass="Shirukiz\JeuxVideoBundle\Repository\JeuxRepository")
 */
class Jeux
{
    /**
     ...
     * @var string
     *
     * @ORM\ManyToOne(targetEntity="Shirukiz\JeuxVideoBundle\Entity\Plateforme", cascade={"persist"})
     */
    private $plateforme;
    /**
     * @var string
